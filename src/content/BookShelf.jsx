...
function BookShelf(props) {
    ...
    return <div>
        <Row>
            {bookLanes.favorites.length != 0 ? bookLanes.favorites.map(r => <BookCard key={crypto.randomUUID()} title={r} name={r}></BookCard>) : bookLanes.isLoggedIn ? <p style={{fontSize: 40}}>you should really get some books here</p> : <div style={{fontSize: 40, fontWeight: "bolder"}}>
